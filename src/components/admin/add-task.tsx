...
const formSchema = z.object({
  ...
  assignedTo: z.coerce.string().min(1, "Please assign the task."),
...
export function AddTask() {
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      ...
      const assignee = employees.find((e) => String(e.id) === String(values.assignedTo));
      toast({
        title: "Task Assigned",
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[560px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Delegate a clear deliverable. Required fields are marked.
          </DialogDescription>
        </DialogHeader>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      {...field}
                      placeholder="e.g., Prepare Q1 revenue report"
                      maxLength={120}
                    />
                  </FormControl>
                  <FormMessage />
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription className="text-[10px]">
                    Be specific — the clearer the brief, the better the outcome.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
